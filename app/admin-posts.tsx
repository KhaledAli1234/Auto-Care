          ...
          {actionPost && (
            <View style={styles.previewCard}>
              <Text style={styles.previewAuthor}>
                {resolveAuthor(actionPost.createdBy)}
              </Text>
          ...
          {actionPost?.status === 'pending' && (
            <>
              <Pressable
                ...
                onPress={() =>
                  handleAction(actionPost._id ?? actionPost.id!, 'approve')
                }
                disabled={processing}
              >
                {processing ? (
              ...
              <Pressable
                ...
                onPress={() =>
                  handleAction(actionPost._id ?? actionPost.id!, 'reject')
                }
                disabled={processing}
              >
                {processing ? (
                  ...
                  <>
                    <Ionicons
                      ...
                      color={COLORS.danger}
                    />
                    <Text style={styles.rejectBtnText}>Reject Post</Text>
                  </>
                )}
              </Pressable>
            </>
