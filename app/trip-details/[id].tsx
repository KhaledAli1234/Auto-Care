      ...
      >
        ...
        <View style={[styles.scoreCard, { backgroundColor: scoreBg }]}>
          ...
          {trip.driving_behavior?.driver_style && (
            <Text style={styles.scoreCardStyle}>
              {trip.driving_behavior.driver_style} Driver
            </Text>
          )}
        </View>
        ...
        {trip.trip_summary && (
          <>
            ...
            <View style={styles.metricsGrid}>
              <MetricCard
                label="Distance"
                value={`${trip.trip_summary.distance_km} km`}
              ...
              <MetricCard
                label="Duration"
                value={formatDuration(trip.trip_summary.duration_min)}
                icon="time-outline"
                styles={styles}
                COLORS={COLORS}
              />
              ...
              <MetricCard
                label="Avg Speed"
                value={`${trip.trip_summary.avg_speed} km/h`}
              ...
              <MetricCard
                label="Max Speed"
                value={`${trip.trip_summary.max_speed} km/h`}
        ...
        {trip.vehicle_health && (
          <>
            ...
            <View style={styles.card}>
              <View style={styles.healthOverviewRow}>
                <View>
                  ...
                  <Text style={styles.healthRiskText}>
                    Risk: {trip.vehicle_health.maintenance_risk}
                  </Text>
                </View>
              ...
              <HealthBar
                label="Engine"
                value={trip.vehicle_health.engine_health}
                styles={styles}
                COLORS={COLORS}
              />
              ...
              <HealthBar
                label="Brakes"
                value={trip.vehicle_health.brake_health}
                styles={styles}
                COLORS={COLORS}
              />
              ...
              <HealthBar
                label="Tires"
                value={trip.vehicle_health.tire_health}
                styles={styles}
                COLORS={COLORS}
              />
              ...
              <View style={styles.fuelRow}>
                <View style={styles.fuelItem}>
                  ...
                  <Text style={styles.fuelValue}>
                    {trip.fuel_efficiency.actual_fuel_l_100km} L/100km
                  </Text>
                </View>
                ...
                <View style={styles.fuelItem}>
                  ...
                  <Text style={styles.fuelValue}>
                    {trip.fuel_efficiency.base_fuel_l_100km} L/100km
                  </Text>
                </View>
              </View>
        ...
        <View
          style={[
            styles.statusBadge,
            {
              backgroundColor: trip.confirmed
                ? `${COLORS.green}1A`
                : `${COLORS.yellow}1A`,
              borderColor: trip.confirmed ? COLORS.green : COLORS.yellow,
            },
          ]}
        >
          <Ionicons
            name={trip.confirmed ? 'checkmark-circle-outline' : 'time-outline'}
            size={16}
            color={trip.confirmed ? COLORS.green : COLORS.yellow}
          />
...
function HealthBar({
  ...
  const color =
    value >= 80 ? COLORS.green : value >= 60 ? COLORS.yellow : COLORS.danger;
